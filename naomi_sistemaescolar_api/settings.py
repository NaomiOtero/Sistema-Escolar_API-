...
ROOT_URLCONF = 'naomi_sistemaescolar_api.urls'
...
WSGI_APPLICATION = 'naomi_sistemaescolar_api.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'naomi_sistemaescolar_api.models.BearerTokenAuthentication',
    ),
